...
\begin{enumerate}
    \item Исследовать технологии и существующие системы для задачи распознавания автомобильных номеров \vspace{0.5em}
    \item Выбрать наиболее подходящие инструменты \vspace{0.5em}
...
\begin{itemize}
    \item Получена высокая точность (>95\%) и уверенность ($\sim$ 0.85) модели распознавания
